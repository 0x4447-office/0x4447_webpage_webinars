<template>
  <b-card class="border-0">
    ...
    >
      ...
      <b-form-group id="input-group-1" label="First Name:" label-for="input-1" label-align="left">
        <b-form-input
          id="input-1"
      ...
      <b-form-group id="input-group-2" label="Last Name:" label-for="input-2" label-align="left">
        <b-form-input
          id="input-2"
      ...
      <b-form-group id="input-group-5" label="Authorized Reseller Name:" label-for="input-5" label-align="left">
        <b-form-input
          id="input-5"
      ...
      <b-form-group id="input-group-6" label="Authorized Reseller AWS Account ID:" label-for="input-6" label-align="left">
        <b-form-input
          id="input-6"
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      let authorized_reseller_name = this.form.authorized_reseller_name.replace(/ /g,"_")
